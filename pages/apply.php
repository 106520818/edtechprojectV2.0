    ...
    <form method="post" action="https://mercury.swin.edu.au/it000000/formtest.php">
        <fieldset>
            ...
            <p>
                ...
                <input type="text" name="Job reference number" id="job_reference_number" required="required"
        ...
        <fieldset>
            ...
            <p>
                ...
                <input type="text" name="Given Name" id="given_name" required="required" pattern="[a-zA-Z]{1,20}" title="Between 1 and 20 alphanumeric characters">
            </p>
            <p>
                <label for="family_name">Family Name</label>
                <input type="text" name="Family Name" id="family_name" required="required" pattern="[a-zA-Z]{1,20}" title="Between 1 and 20 alphanumeric characters">
            </p>
            <p>
            ...
            <p>
                ...
                <input type="text" name="Street Address" id="street_address" required="required"
                    pattern="[a-zA-Z0-9]{1,40}" title="Between 1 and 40 alphanumeric characters">
            </p>
            <p>
                <label for="suburb">Suburb/Town</label>
                <input type="text" name="Suburb/Town" id="suburb" required="required" pattern="[a-zA-Z]{1,40}" title="Between 1 and 40 alphabetical characters">
            </p>
            <p>
            ...
            <p>
                ...
                <input type="text" name="Phone Number" id="phone_number" required="required" pattern="[0-9]{8,12}" title="8-12 numeric characters">
            </p>
        </fieldset>
        <fieldset>
            ...
            <p>
                ...
                <input type="text" id="other_skills" name="Other Skills">
            </p>
        </fieldset>
